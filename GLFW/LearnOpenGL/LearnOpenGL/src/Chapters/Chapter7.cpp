...
static  GLFWwindow* setupGLFW(const std::string &addToName)
{
	//glfwInit();
	...
	//std::string defaultName = "Chapter 7";
	//std::string windowName = defaultName + addToName;
...
static int Chapter7_usingTextures()
{
